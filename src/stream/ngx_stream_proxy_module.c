...
static ngx_command_t ngx_stream_proxy_commands[] = {
    ...
    {ngx_string("proxy_socket_keepalive"),
     ...
     offsetof(ngx_stream_proxy_srv_conf_t, socket_keepalive), NULL},

    {ngx_string("proxy_connect_timeout"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, connect_timeout), NULL},

    {ngx_string("proxy_timeout"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, timeout), NULL},

    {ngx_string("proxy_buffer_size"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, buffer_size), NULL},
    ...
    {ngx_string("proxy_upload_rate"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_stream_set_complex_value_size_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, upload_rate), NULL},

    {ngx_string("proxy_download_rate"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_stream_set_complex_value_size_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, download_rate), NULL},

    {ngx_string("proxy_requests"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, requests), NULL},

    {ngx_string("proxy_responses"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, responses), NULL},

    {ngx_string("proxy_next_upstream"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, next_upstream), NULL},

    {ngx_string("proxy_next_upstream_tries"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, next_upstream_tries), NULL},

    {ngx_string("proxy_next_upstream_timeout"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, next_upstream_timeout), NULL},

    {ngx_string("proxy_protocol"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, proxy_protocol), NULL},

    {ngx_string("proxy_protocol_version"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, protocol_version), NULL},

    {ngx_string("proxy_half_close"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, half_close), NULL},
    ...
    {ngx_string("proxy_ssl"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_enable), NULL},

    {ngx_string("proxy_ssl_session_reuse"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_session_reuse), NULL},

    {ngx_string("proxy_ssl_protocols"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_1MORE,
     ngx_conf_set_bitmask_slot, NGX_STREAM_SRV_CONF_OFFSET,
    ...
    {ngx_string("proxy_ssl_ciphers"),
     ...
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_ciphers), NULL},

    {ngx_string("proxy_ssl_name"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_stream_set_complex_value_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_name), NULL},

    {ngx_string("proxy_ssl_server_name"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_server_name), NULL},

    {ngx_string("proxy_ssl_verify"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_verify), NULL},

    {ngx_string("proxy_ssl_verify_depth"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_verify_depth), NULL},

    {ngx_string("proxy_ssl_trusted_certificate"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_trusted_certificate), NULL},

    {ngx_string("proxy_ssl_crl"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_crl), NULL},

    {ngx_string("proxy_ssl_certificate"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_stream_set_complex_value_zero_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_certificate), NULL},

    {ngx_string("proxy_ssl_certificate_key"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE1,
     ngx_stream_set_complex_value_zero_slot, NGX_STREAM_SRV_CONF_OFFSET,
     offsetof(ngx_stream_proxy_srv_conf_t, ssl_certificate_key), NULL},

    {ngx_string("proxy_ssl_certificate_cache"),
     NGX_STREAM_MAIN_CONF | NGX_STREAM_SRV_CONF | NGX_CONF_TAKE123,
     ngx_stream_proxy_ssl_certificate_cache, NGX_STREAM_SRV_CONF_OFFSET, 0,
     NULL},
    ...
    {ngx_string("proxy_ssl_conf_command"),
     ...
     ngx_conf_set_keyval_slot, NGX_STREAM_SRV_CONF_OFFSET,
...
static void ngx_stream_proxy_handler(ngx_stream_session_t *s) {
  ...
  s->upstream_states =
      ngx_array_create(c->pool, 1, sizeof(ngx_stream_upstream_state_t));
  ...
  if (u->resolved == NULL) {
    ...
    if (u->resolved->sockaddr) {
      ...
      if (u->resolved->port == 0 &&
        ...
        ngx_log_error(NGX_LOG_ERR, c->log, 0, "no port in upstream \"%V\"",
                      host);
        ngx_stream_proxy_finalize(s, NGX_STREAM_INTERNAL_SERVER_ERROR);
        return;
      }
    ...
    if (ctx == NGX_NO_RESOLVER) {
      ngx_log_error(NGX_LOG_ERR, c->log, 0, "no resolver defined to resolve %V",
                    host);
      ngx_stream_proxy_finalize(s, NGX_STREAM_INTERNAL_SERVER_ERROR);
      return;
    }
...
static ngx_int_t ngx_stream_proxy_eval(ngx_stream_session_t *s,
  ...
  if (ngx_parse_url(s->connection->pool, &url) != NGX_OK) {
    if (url.err) {
      ngx_log_error(NGX_LOG_ERR, s->connection->log, 0, "%s in upstream \"%V\"",
                    url.err, &url.url);
    }
  ...
  u->resolved =
      ngx_pcalloc(s->connection->pool, sizeof(ngx_stream_upstream_resolved_t));
  if (u->resolved == NULL) {
    return NGX_ERROR;
  }
...
static void ngx_stream_proxy_connect(ngx_stream_session_t *s) {
  ...
  if (u->upstream && u->upstream->shm_zone &&
    ...
    u->state->peer =
        ngx_palloc(s->connection->pool, sizeof(ngx_str_t) + u->peer.name->len);
...
static void ngx_stream_proxy_init_upstream(ngx_stream_session_t *s) {
  ...
  if (c->log->log_level >= NGX_LOG_INFO) {
    ...
    if (ngx_connection_local_sockaddr(pc, &str, 1) == NGX_OK) {
      ...
      ngx_log_error(NGX_LOG_INFO, c->log, 0, "%sproxy %V connected to %V",
  ...
  if (u->proxy_protocol) {
    ...
    if (pscf->protocol_version == 2) {
      ...
      p = ngx_proxy_protocol_write(c, p, p + NGX_PROXY_PROTOCOL_V1_MAX_HEADER);
    }
    if (p == NULL) {
      ngx_stream_proxy_finalize(s, NGX_STREAM_INTERNAL_SERVER_ERROR);
      return;
...
static char *ngx_stream_proxy_ssl_certificate_cache(ngx_conf_t *cf,
  ...
  pscf->ssl_certificate_cache =
      ngx_ssl_cache_init(cf->pool, max, valid, inactive);
  if (pscf->ssl_certificate_cache == NULL) {
    return NGX_CONF_ERROR;
  }
...
static void ngx_stream_proxy_ssl_init_connection(ngx_stream_session_t *s) {
  ...
  if (ngx_ssl_create_connection(pscf->ssl, pc,
  ...
  if (pscf->ssl_certificate && pscf->ssl_certificate->value.len &&
      (pscf->ssl_certificate->lengths || pscf->ssl_certificate_key->lengths)) {
...
static ngx_int_t ngx_stream_proxy_ssl_certificate(ngx_stream_session_t *s) {
  ...
  if (ngx_stream_complex_value(s, pscf->ssl_certificate, &cert) != NGX_OK) {
    return NGX_ERROR;
  }
  ...
  if (ngx_stream_complex_value(s, pscf->ssl_certificate_key, &key) != NGX_OK) {
    return NGX_ERROR;
  }
      ...
      if (s->connection->type == SOCK_DGRAM) {
        ...
        if (pscf->responses == NGX_MAX_INT32_VALUE ||
          ...
          ngx_log_error(NGX_LOG_INFO, c->log, 0,
                        ...
                        u->requests, u->responses, s->received, c->sent,
...
static void ngx_stream_proxy_process(ngx_stream_session_t *s,
  ...
  if (dst) {
    ...
    if (dst->type == SOCK_STREAM && pscf->half_close && src->read->eof &&
        !u->half_closed && !dst->buffered) {
...
static ngx_int_t ngx_stream_proxy_test_finalize(ngx_stream_session_t *s,
  ...
  if (c->type == SOCK_DGRAM) {
    ...
    ngx_log_error(NGX_LOG_INFO, c->log, 0,
                  ...
                  ", bytes from/to client:%O/%O"
                  ", bytes from/to upstream:%O/%O",
                  u->requests, u->responses, s->received, c->sent, u->received,
                  pc ? pc->sent : 0);
  ...
  if (pc == NULL || (!c->read->eof && !pc->read->eof) ||
      (!c->read->eof && c->buffered) || (!pc->read->eof && pc->buffered)) {
    return NGX_DECLINED;
  }
...
static u_char *ngx_stream_proxy_log_error(ngx_log_t *log, u_char *buf,
  ...
  p = ngx_snprintf(p, len,
                   ", bytes from/to client:%O/%O"
                   ", bytes from/to upstream:%O/%O",
                   s->received, s->connection->sent, u->received,
                   pc ? pc->sent : 0);
...
static char *ngx_stream_proxy_merge_srv_conf(ngx_conf_t *cf, void *parent,
  ...
  ngx_conf_merge_uint_value(conf->responses, prev->responses,
                            NGX_MAX_INT32_VALUE);
  ...
  ngx_conf_merge_ptr_value(conf->ssl_certificate, prev->ssl_certificate, NULL);

  ngx_conf_merge_ptr_value(conf->ssl_certificate_key, prev->ssl_certificate_key,
                           NULL);
...
static ngx_int_t ngx_stream_proxy_merge_ssl(ngx_conf_t *cf,
  ...
  if (conf->ssl_protocols == 0 && conf->ssl_ciphers.data == NULL &&
      conf->ssl_certificate == NGX_CONF_UNSET_PTR &&
      conf->ssl_certificate_key == NGX_CONF_UNSET_PTR &&
      conf->ssl_passwords == NGX_CONF_UNSET_PTR &&
      conf->ssl_verify == NGX_CONF_UNSET &&
      ...
      conf->ssl_crl.data == NULL && conf->ssl_session_reuse == NGX_CONF_UNSET &&
      conf->ssl_conf_commands == NGX_CONF_UNSET_PTR) {
    if (prev->ssl) {
      conf->ssl = prev->ssl;
      return NGX_OK;
...
ngx_stream_proxy_merge_ssl_passwords(ngx_conf_t *cf,
  ...
  if (conf->ssl_certificate == NULL || conf->ssl_certificate->value.len == 0 ||
...
static ngx_int_t ngx_stream_proxy_set_ssl(ngx_conf_t *cf,
  ...
  if (pscf->ssl_certificate && pscf->ssl_certificate->value.len) {
    ...
    if (pscf->ssl_certificate->lengths == NULL &&
      ...
      if (ngx_ssl_certificate(cf, pscf->ssl, &pscf->ssl_certificate->value,
  ...
  if (ngx_ssl_conf_commands(cf, pscf->ssl, pscf->ssl_conf_commands) != NGX_OK) {
    return NGX_ERROR;
  }
...
static char *ngx_stream_proxy_pass(ngx_conf_t *cf, ngx_command_t *cmd,
  ...
  if (cv.lengths) {
    pscf->upstream_value =
        ngx_palloc(cf->pool, sizeof(ngx_stream_complex_value_t));
...
static char *ngx_stream_proxy_bind(ngx_conf_t *cf, ngx_command_t *cmd,
  ...
  if (cv.lengths) {
    ...
    *local->value = cv;
    ...
    rc =
        ngx_parse_addr_port(cf->pool, local->addr, value[1].data, value[1].len);
