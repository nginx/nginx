...
static ngx_int_t
    ...
    ngx_table_elt_t *h, ngx_uint_t offset);
#if (NGX_HTTP_CACHE)
static ngx_uint_t ngx_http_upstream_cc_directive(ngx_http_request_t *r,
    ngx_table_elt_t *h, ngx_str_t *name);
...
static ngx_uint_t
ngx_http_upstream_cc_directive(ngx_http_request_t *r, ngx_table_elt_t *h,
    ngx_str_t *name)
{
    ngx_str_t  value;
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    *ph = h;
    ...
    if (ngx_http_upstream_cc_directive(r, h, &ngx_http_upstream_cc_no_cache)
        || ngx_http_upstream_cc_directive(r, h, &ngx_http_upstream_cc_no_store)
        || ngx_http_upstream_cc_directive(r, h, &ngx_http_upstream_cc_private))
    {
