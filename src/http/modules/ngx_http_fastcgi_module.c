...
static char *ngx_http_fastcgi_buffer_size_check(ngx_conf_t *cf, void *post,
    void *data);

static ngx_conf_post_t  ngx_http_fastcgi_lowat_post =
    { ngx_http_fastcgi_lowat_check };
static ngx_conf_post_t  ngx_http_fastcgi_buffer_size_post =
    { ngx_http_fastcgi_buffer_size_check };
...
static ngx_command_t  ngx_http_fastcgi_commands[] = {
    ...
    { ngx_string("fastcgi_buffer_size"),
      ...
      &ngx_http_fastcgi_buffer_size_post },
...
static char *
ngx_http_fastcgi_buffer_size_check(ngx_conf_t *cf, void *post, void *data)
{
    size_t *sp = data;
