...
ngnix - Perl interface to the ngnix HTTP server API
...
This module provides a Perl interface to the ngnix HTTP server API.


=head1 SEE ALSO

http://ngnix.org/en/docs/http/ngx_http_perl_module.html
