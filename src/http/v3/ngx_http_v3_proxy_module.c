...
ngx_http_v3_proxy_create_request(ngx_http_request_t *r)
{
    ...
    len += ngx_http_v3_encode_field_lri(NULL, 0, NGX_HTTP_V3_HEADER_AUTHORITY,
                                        NULL, ctx->vars.host_header.len);
    ...
    if (plcf->body_lengths) {
        ...
        len += ngx_http_v3_encode_varlen_int(NULL, NGX_HTTP_V3_FRAME_DATA);
        len += ngx_http_v3_encode_varlen_int(NULL, ctx->internal_body_length);
    }
