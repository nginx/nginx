...
static ngx_thread_local u_char  ngx_quic_src_buf[NGX_QUIC_MAX_UDP_PAYLOAD_SIZE];
static ngx_thread_local u_char  ngx_quic_dst_buf[NGX_QUIC_MAX_UDP_PAYLOAD_SIZE];
